...
`src/router/OvertimeChallengeRouter.sol` is the canonical challenge identity and WETH settlement
boundary. Ordinary swaps remain permissionless; non-empty hook data is accepted only from this
router for exact-input WETH-to-OVERTIME challenges.
